using AMKDotNetCore.ATMWebApp.EFDbContext;
...
namespace AMKDotNetCore.ATMWebApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var str = HttpContext.Session.GetString("LoggedInAccount");
            

            if (str != null)
            {
                Account loggedInAccount = JsonConvert.DeserializeObject<Account>(str);
